...
create_statation_mysql_task = MySqlOperator(
    ...
    sql='./mysqlDatabase/create_stations.sql',
    dag=dag
)
...
load_statation = MySqlOperator(
    ...
    mysql_conn_id='mysql_conn_id',
    sql='./mysqlDatabase/insert_stations.sql',
    dag=dag
)
...
create_obs_table_mysql_task = MySqlOperator(
    ...
    mysql_conn_id='mysql_conn_id',
    sql='./mysqlDatabase/create_table.sql',
    dag=dag
)
...
load_obs_data = MySqlOperator(
    ...
    mysql_conn_id='mysql_conn_id',
    sql='./mysqlDatabase/insert_obs.sql',
    dag=dag
)
...
create_station_summary_table_mysql_task = MySqlOperator(
    ...
    mysql_conn_id='mysql_conn_id',
    sql='./mysqlDatabase/create_station_summary_table.sql',
    dag=dag
)
...
load_station_summary_data = MySqlOperator(
    ...
    mysql_conn_id='mysql_conn_id',
    sql='./mysqlDatabase/insert_station_summary_data.sql',
    dag=dag
)
